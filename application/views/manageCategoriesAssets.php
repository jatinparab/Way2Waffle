                ...
                <div class="col-lg-12">
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                                    ...
                                    <tbody>
                                        <?php 
                                            while($row = $res -> fetch_assoc()){
                                                ...
                                                echo "<td>".$row['id']."</td>";
                                                echo "<td>".$row['name']."</td>";
                                                echo "<td><button type=\"button\"  class=\"btn btn-danger btn-sm btnDelete\" onclick=\"deleteCatAss('".$row['id']."');\" title=\"Delete\" ><span class=\"glyphicon glyphicon-trash\"></span></button></td>";
                                            }
                                        ?>
                                    </tbody>  
                                    </table>
                            ...
                            <button class="btn btn-info"  onclick="addNewAss()">Add New </button>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
...
<script>
    ...
    function deleteCatAss(id){
        $.ajax({
            type: "GET",
            contentType: "application/json; charset=utf-8",
            url: "ajax_deleteCategoryAssets",
            data: {
                'id':id
            },
            success: function (result) {
