                ...
                <div class="sidebar-nav navbar-collapse">
					...
					<?php if($_SESSION['user_type'] != 'chef'){ ?>
                        ...
                        <li>
                         ...
                         <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Asset Management<span class="fa arrow"></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url();?>index.php/Admin/assets">View Assets</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>index.php/Admin/addAssets">Add Assets</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>index.php/Admin/manageCategoriesAssets">Manage Categories</a>
                                </li>
                            </ul>
                        </li>
